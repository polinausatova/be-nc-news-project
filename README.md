...
For anyone who wishes to clone your project and run it locally: you will need to create .env files with the environment variables in order to successfully connect to the two databases for development and test data.
